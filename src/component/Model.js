...
const Model = ({ showModal, closeModal, message }) => {
  if (!showModal) return null; // Return nothing if showModal is false
  ...
  return (
    ...
    >
      <div className="relative p-4 w-full max-w-md bg-white rounded-lg shadow-lg dark:bg-green-700">
        <button
          type="button"
