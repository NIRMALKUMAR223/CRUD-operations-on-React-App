...
const Update = () => {
  ...
  return (
    <div className='bg-gray-200 text-center w-62 m-2'>
            <div className='bg-blue-500 p-2 w-92 rounded-2xl text-2xl' >
                <h1 className='text-3xl m-2 text-3xl text-white'>Update Student Records</h1>
                <label className='p-1 ' >Name : <input value={inputValues.name}  className='m-2 rounded p-0.5' type='text' placeholder=' Name' name='name' onChange={updateState}/></label><br/>
                <label className='p-1 '>Age : <input value={inputValues.age} className='m-2 rounded p-0.5' type='number' placeholder=' Age' name='age' onChange={updateState}/></label><br/>
                <label className='p-1 '>Email : <input  value={inputValues.email} className='m-2 rounded p-0.5' type='email' placeholder=' Email' name='email' onChange={updateState}/></label><br/>
                <label className='p-1 '>Password : <input value={inputValues.password} className='m-2 rounded p-0.5' type='password' placeholder=' Password' name='password' onChange={updateState}/></label><br/>
                ...
                />}
            <div className='bg-blue-500 text-center w-screen'>
